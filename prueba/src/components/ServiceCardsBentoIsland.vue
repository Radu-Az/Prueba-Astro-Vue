<template>
  ...
  <div class="grid grid-cols-1 items-start gap-4 md:grid-cols-6">
    <article
      ...
      :class="[
        'service-card group relative z-0 overflow-hidden rounded-2xl border border-slate-200/80 bg-white/95 px-5 py-4 text-center shadow-sm shadow-slate-200/70 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:shadow-slate-300/40',
        card.size,
      ]"
      role="button"
      tabindex="0"
    ...
    >
      <div class="pointer-events-none absolute inset-x-0 top-0 h-16 bg-gradient-to-b from-white to-transparent" aria-hidden="true"></div>

      <span
        class="service-icon absolute bottom-2 left-1/2 z-10 -translate-x-1/2 text-xs font-semibold leading-none text-slate-400 transition-all duration-300 group-hover:opacity-0 group-focus-within:opacity-0"
